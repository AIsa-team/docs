...
<CardGroup cols={2}>
  ...
  <Card title="事件查询" icon="calendar-days">
    查看 Polymarket 事件组及相关市场。
  </Card>
  <Card title="交易历史" icon="chart-line">
    按可选 ticker 和 block trade 过滤条件拉取近期 Kalshi 交易。
  </Card>
...
<CardGroup cols={3}>
  <Card title="预测市场数据" icon="chart-simple" href="/zh/agent-skills/prediction-market-data">
    英文技能的中文镜像版预测市场数据说明。
  </Card>
  <Card title="预测市场套利（中文）" icon="scale-balanced" href="/zh/agent-skills/prediction-market-arbitrage-zh">
    中文跨市场研究流程。
  </Card>
  <Card title="预测市场 API" icon="code" href="/api-reference/prediction-market/get_polymarket-events">
    Polymarket 和 Kalshi 已挂载端点文档。
  </Card>
</CardGroup>
