...
<CardGroup cols={2}>
  <Card title="跨市场发现" icon="shuffle">
    针对同一话题找出相关的 Polymarket 和 Kalshi 市场。
  </Card>
  <Card title="候选配对" icon="arrows-left-right">
    比较标题、slug、ticker、事件名称和结束时间。
  </Card>
  <Card title="流动性初筛" icon="droplet">
    用 discovery 返回中的成交量/流动性字段决定进一步研究的方向。
  </Card>
  <Card title="中文总结" icon="language">
    基于已挂载的市场数据产出中文研究笔记。
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Prediction Market Data ZH" icon="chart-simple" href="/zh/agent-skills/prediction-market-data-zh">
    中文版市场数据工作流。
  </Card>
  <Card title="Prediction Market API" icon="code" href="/zh/api-reference/prediction-market/get_polymarket-markets">
    已挂载的 Polymarket 和 Kalshi endpoint 参考。
  </Card>
</CardGroup>
