...
description: "按 id 获取 Google Jobs 高级结果。"
...
按 id 获取 Google Jobs 高级结果。发布任务后，可在保留期限内通过任务 id 检索结果。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-advanced-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-advanced-id)
