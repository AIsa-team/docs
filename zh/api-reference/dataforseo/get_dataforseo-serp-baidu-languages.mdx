...
Baidu SERP 语言列表。返回 Baidu SERP 支持的语言列表。使用此端点不会向您的账户收费。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-serp-baidu-languages.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-serp-baidu-languages)
