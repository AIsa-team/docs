...
description: "实时 Google Dataset Info Advanced。"
...
实时 Google Dataset Info Advanced。实时返回 Google Dataset Info 结果。每次 Live SERP API 调用只能包含一个任务。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-serp-google-dataset-info-live-advanced.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-serp-google-dataset-info-live-advanced)
