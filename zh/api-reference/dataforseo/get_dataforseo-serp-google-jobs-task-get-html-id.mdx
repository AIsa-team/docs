---
title: "按 id 获取 Google Jobs HTML 结果"
description: "按 id 获取 Google Jobs HTML 结果。"
openapi: "openapi/zh/dataforseo.json GET /dataforseo/serp/google/jobs/task_get/html/{id}"
---
...
按 id 获取 Google Jobs HTML 结果。返回先前已提交任务的 HTML 结果。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-html-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-html-id)
