...
description: "取回单个 Google Play 应用的商店页：描述、开发者、评分、安装量、截图、版本历史。"
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-app-data-google-app-info-task-get-advanced-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-app-data-google-app-info-task-get-advanced-id)
