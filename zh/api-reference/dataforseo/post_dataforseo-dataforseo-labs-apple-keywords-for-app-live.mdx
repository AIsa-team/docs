...
此端点将提供目标应用在 App Store 中获得排名的关键词列表。您将获取关键词数据，并了解该应用在每个返回关键词下的排名位置。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-keywords-for-app-live.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-keywords-for-app-live)
