...
description: "实时 Yahoo 自然搜索 SERP Advanced。"
...
实时 Yahoo 自然搜索 SERP Advanced。实时返回高级 Yahoo 自然搜索 SERP 结果。每次 Live SERP API 调用只能包含一个任务。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-serp-yahoo-organic-live-advanced.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-serp-yahoo-organic-live-advanced)
