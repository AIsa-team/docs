...
description: "按 id 获取 Baidu Organic SERP 高级结果。"
...
按 id 获取 Baidu Organic SERP 高级结果。返回此前提交的 Baidu Organic 任务的高级 SERP 结果。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-serp-baidu-organic-task-get-advanced-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-serp-baidu-organic-task-get-advanced-id)
