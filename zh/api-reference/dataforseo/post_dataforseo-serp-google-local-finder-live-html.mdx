...
实时 Google Local Finder SERP HTML。实时返回 Google Local Finder SERP 结果的原始 HTML。每次 Live SERP API 调用只能包含一个任务。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-serp-google-local-finder-live-html.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-serp-google-local-finder-live-html)
