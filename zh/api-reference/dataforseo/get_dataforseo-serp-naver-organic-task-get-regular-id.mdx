---
title: "按 id 获取 Naver 自然搜索 SERP 结果（常规）"
description: "按 id 获取 Naver Organic SERP 结果（常规）。"
openapi: "openapi/zh/dataforseo.json GET /dataforseo/serp/naver/organic/task_get/regular/{id}"
---
...
按 id 获取 Naver Organic SERP 结果（常规）。返回此前提交的 Naver Organic 任务的常规 SERP 结果。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/get_dataforseo-serp-naver-organic-task-get-regular-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/get_dataforseo-serp-naver-organic-task-get-regular-id)
