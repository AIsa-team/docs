...
description: "设置 Google Search By Image SERP 任务。"
...
设置 Google Search By Image SERP 任务。仅在设置任务时向您的账户收费。每次 POST 调用最多可发送 100 个任务，之后可通过任务 id 或 postback/pingback 获取已完成的结果。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-serp-google-search-by-image-task-post.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-serp-google-search-by-image-task-post)
