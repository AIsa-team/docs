...
description: "Google Hotel Info 将为您提供 [Google Hotels](http://www."
...
Google Hotel Info 将为您提供 [Google Hotels](http://www.google.com/travel/hotels) 平台上特定酒店实体的非结构化 HTML 数据，例如服务描述、位置详情、评分、设施、评论、图片、价格等。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-business-data-google-hotel-info-live-html.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-business-data-google-hotel-info-live-html)
