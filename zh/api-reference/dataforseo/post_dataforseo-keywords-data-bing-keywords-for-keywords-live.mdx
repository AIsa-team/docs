...
此端点将为指定关键词选择相关关键词。最多设置 200 个关键词，并获取 Bing Ads 针对你的查询建议的结果。使用此功能最多可获得 3000 个关键词建议。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-keywords-data-bing-keywords-for-keywords-live.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-keywords-data-bing-keywords-for-keywords-live)
