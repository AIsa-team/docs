---
title: "设置实时 Google My Business Info 任务"
description: "Business Data API 提供包含 Google 上特定企业实体信息的结果。"
openapi: "openapi/zh/dataforseo.json POST /dataforseo/business_data/google/my_business_info/live"
---
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-business-data-google-my-business-info-live.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-business-data-google-my-business-info-live)
