...
description: "实时 Google Finance Markets SERP HTML。"
...
实时 Google Finance Markets SERP HTML。实时返回 Google Finance Markets 标签页的原始 HTML。每次 Live SERP API 调用只能包含一个任务。
...
//   https://aisa.one/docs/zh/api-reference/dataforseo/post_dataforseo-serp-google-finance-markets-live-html.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/dataforseo/post_dataforseo-serp-google-finance-markets-live-html)
