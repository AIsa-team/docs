...
//   https://aisa.one/docs/zh/api-reference/agentmail/get_agentmail-inboxes-inbox-id-drafts-draft-id.md
...
[在你的 agent 里把这个端点跑起来 →](https://aisa.one/mcp?from=/zh/api-reference/agentmail/get_agentmail-inboxes-inbox-id-drafts-draft-id)
