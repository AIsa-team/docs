...
- [Agent Skills](/zh/agent-skills) — 浏览完整预构建 skills catalogue
- [快速入门](/zh/agent-skills/quickstart) — 5 分钟安装第一个 skill
- [标准](/zh/agent-skills/standards) — 了解 SKILL.md 文件如何工作，以及如何编写自己的 skill
