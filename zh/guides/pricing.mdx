...
SimilarWeb 是付费数据 API，使用 credit 公式。不同端点的费用可能固定、由请求维度决定，或由返回行数决定。发起付费请求前，请阅读 [SimilarWeb 价格与成本控制](/zh/guides/pricing/similarweb)；页面会展示当前公式、费用驱动因素、示例和端点级控制方式。
