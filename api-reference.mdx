---
title: "API Reference"
description: "One key, one base URL, every API. Browse every endpoint AIsa routes to with interactive examples."
---
...
<CardGroup cols={2}>
  <Card title="Chat API" icon="comments" href="/api-reference/chat/post_chat-completions">
  ...
  <Card title="Scholar API" icon="graduation-cap" href="/api-reference/scholar/post_scholar-search-scholar">
...
<CardGroup cols={3}>
  ...
  <Card title="Credit Balance" icon="wallet" href="/api-reference/credits-balance">
