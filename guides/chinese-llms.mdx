...
| -------------------------------- | ------------- | ---------------- | ------------------------------------------ | -------------------------- |
| `qwen3.6-plus`                   | Alibaba Cloud | 1,000,000 tokens | Frontier reasoning + ultra-long context    | [Qwen →](/guides/chinese-llms/qwen)           |
| `qwen3-max`                      | Alibaba Cloud | 262,144 tokens   | Balanced capability + cost                 | [Qwen →](/guides/chinese-llms/qwen)           |
| `qwen3-coder-plus`               | Alibaba Cloud | 262,144 tokens   | Code generation and completion             | [Qwen →](/guides/chinese-llms/qwen)           |
| `qwen3-coder-flash`              | Alibaba Cloud | 262,144 tokens   | Fast, high-throughput coding               | [Qwen →](/guides/chinese-llms/qwen)           |
| `qwen3-coder-480b-a35b-instruct` | Alibaba Cloud | 262,144 tokens   | Maximum coding capability (480B MoE)       | [Qwen →](/guides/chinese-llms/qwen)           |
| `deepseek-v3.2`                  | DeepSeek      | 128,000 tokens   | Cost-efficient general use + coding        | [DeepSeek →](/guides/chinese-llms/deepseek)   |
| `kimi-k2.5`                      | Moonshot AI   | 256,000 tokens   | Visual coding + agentic tool-calling       | [Kimi →](/guides/chinese-llms/kimi)           |
| `MiniMax-M2.5`                   | MiniMax       | 196,608 tokens   | Long-context reasoning, multilingual       | [MiniMax →](/guides/chinese-llms/minimax)     |
| `GLM-5`                          | Zhipu AI      | 200,000 tokens   | Chinese-language reasoning + coding        | [GLM-5 →](/guides/chinese-llms/glm)           |
| `seed-1-6-250915`                | ByteDance     | 131,072 tokens   | General reasoning, multilingual, long docs | [ByteDance →](/guides/chinese-llms/bytedance) |
| `seed-1-6-flash-250715`          | ByteDance     | 131,072 tokens   | Fast, high-volume throughput               | [ByteDance →](/guides/chinese-llms/bytedance) |
| `seed-1-8-251228`                | ByteDance     | 131,072 tokens   | Agentic tasks, tool calling                | [ByteDance →](/guides/chinese-llms/bytedance) |
| `seedream-4-5-251128`            | ByteDance     | — (image model)  | Text-to-image up to 4K resolution          | [ByteDance →](/guides/chinese-llms/bytedance) |
...
* [Qwen models — full guide](/guides/chinese-llms/qwen)
* [DeepSeek models — full guide](/guides/chinese-llms/deepseek)
* [Kimi K2.5 — full guide](/guides/chinese-llms/kimi)
* [ByteDance Seed & Seedream — full guide](/guides/chinese-llms/bytedance)
* [MiniMax-M2.5 — full guide](/guides/chinese-llms/minimax)
* [GLM-5 — full guide](/guides/chinese-llms/glm)
* [All supported models](https://aisa.one/docs/guides/models)
