---
title: "Changelog"
description: "A running log of new features, API additions, fixes, and improvements to the AIsa platform. Updated with every significant release."
---
...
> These variant IDs were later consolidated. The gateway now exposes `wan2.7-t2v`, `wan2.7-i2v`, and `wan2.7-r2v` at 720p/1080p — see the [model catalog](/guides/models) for current IDs.
