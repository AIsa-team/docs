---
title: "Pre-Built Skills vs Custom Skills — When to Use Each"
description: >-
...
sidebar_label: "Pre-built vs custom skills"
slug: /learn/agent-skills-vs-tools
---

# Pre-built skills vs custom skills — when to use each

There are two ways to give your AI coding agent new capabilities with AIsa Agent Skills: install a pre-built skill from the [agent-skills](https://github.com/AIsa-team/agent-skills) registry, or write your own `SKILL.md` from scratch. The right choice depends on whether your use case is already covered.
