---
title: "Manual Setup: How to Use AIsa in OpenClaw"
...
<Note>
  Prefer the one-command setup? See [Quick Setup: How to Use AIsa in OpenClaw](/guides/tutorials/openclaw-quick-setup).
</Note>
