---
title: "Use AIsa in OpenClaw"
description: "Use AIsa as OpenClaw's LLM provider, then connect AIsa resource capabilities with one prompt."
---
...
Always use `aisa/<model-id>` - e.g., `aisa/kimi-k2.5`, `aisa/gpt-5.4`, `aisa/claude-opus-4-8`. Add any supported model to the `models` array in your provider config; the full list is in the [model catalog](/guides/models).
