---
title: "Quick Setup: How to Use AIsa in OpenClaw"
...
<Note>
  Prefer editing config by hand? See [Manual Setup: How to Use AIsa in OpenClaw](/guides/tutorials/openclaw-manual-setup) instead.
</Note>
...
<CardGroup cols={3}>
  <Card title="Manual Setup: How to Use AIsa in OpenClaw" icon="screwdriver-wrench" href="/guides/tutorials/openclaw-manual-setup">
