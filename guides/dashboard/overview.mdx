...
excerpt: >-
  ...
  consumption, model usage, and spending across 100+ AI models in real time
...
If your balance runs low, you can add credits using the **Top Up** action in the [AIsa console](https://console.aisa.one/). All values update automatically as usage occurs.
