...
| --------- | ------------ | -------------------- |
| GPT       | OpenAI       | Text, Vision, Audio  |
| Claude    | Anthropic    | Text, Vision         |
| Gemini    | Google       | Text, Vision, Audio  |
| Qwen      | Alibaba      | Text, Vision, Code   |
| DeepSeek  | DeepSeek     | Text, Code           |
| Kimi      | Moonshot AI  | Text                 |
| Seed      | ByteDance    | Text, Image, Video   |
