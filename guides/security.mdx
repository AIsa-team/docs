---
title: Security & Data Privacy – AIsa Unified LLM API
excerpt: >-
  Learn how AIsa handles API requests, data processing, and security. AIsa
  follows a no-storage policy for prompts and outputs, with HTTPS transport
  and API key authentication across all 100+ AI model endpoints.
---
