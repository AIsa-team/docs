...
description: "Integrate your autonomous agents with AIsa using the Google A2A agent card, OpenAI plugin manifest, and OpenAPI 3.1 spec. Covers programmatic discovery, authentication, and end-to-end integration patterns."
---
...
| :--- | :--- | :--- |
| AI Models | `/v1/chat/completions`, `/v1/models` | 50+ LLMs, OpenAI-compatible |
...
| Image Generation | `/v1/images/generations` | GPT-4o, Gemini Imagen, SeedREAM |
