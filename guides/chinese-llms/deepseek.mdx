...
- [All Chinese AI models](/guides/chinese-llms) — Qwen, DeepSeek, Kimi, ByteDance Seed side by side
- [Qwen models](/guides/chinese-llms/qwen) — Alibaba's 1M-context flagship with Key Account partner pricing
- [Kimi K2.5](/guides/chinese-llms/kimi) — 1T parameter MoE for agentic and visual coding tasks
- [ByteDance Seed & Seedream](/guides/chinese-llms/bytedance) — Seed 1.6, 1.8, Flash, and Seedream 4.5 image generation
