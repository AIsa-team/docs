---
title: DeepSeek API - Access DeepSeek Models via AIsa
description: >-
  Current AIsa guide to DeepSeek model IDs, context windows, endpoints, and
  prices, including deepseek-r1, deepseek-v3, deepseek-v3.1, deepseek-v3.2,
