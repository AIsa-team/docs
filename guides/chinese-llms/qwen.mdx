...
- [All Chinese AI models](/guides/chinese-llms) — compare Qwen vs DeepSeek vs Kimi vs ByteDance Seed
- [DeepSeek models](/guides/chinese-llms/deepseek) — DeepSeek V3.2 at industry-leading price-performance
- [Kimi K2.5](/guides/chinese-llms/kimi) — 1T parameter MoE with agentic tool-calling
