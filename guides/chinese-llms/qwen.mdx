---
title: Qwen and Wan API - Access Alibaba Models via AIsa
description: >-
  Current AIsa guide to Alibaba Qwen and Wan model IDs, context windows,
  capabilities, endpoints, and prices, including qwen3.7-max, qwen-flash,
  Qwen VL, Qwen Coder, Wan image models, and translation models.
sidebar_label: Qwen
sidebar_position: 2
