...
<Warning>
  **IMPORTANT:** This page does not make every data API fixed-price. SimilarWeb endpoints may be fixed, priced per returned row, or priced from request dimensions. Read [SimilarWeb Pricing & Cost Control](/guides/pricing/similarweb) before a paid SimilarWeb request.
</Warning>
