---
title: Account Settings – Security, Billing & Notifications
excerpt: >-
  Configure your AIsa account settings including two-factor authentication,
  API access tokens, quota warning notifications, pricing safeguards, and
  privacy controls for your unified LLM gateway.
---
