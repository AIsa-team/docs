...
excerpt: >-
  ...
  for AI agents — built-in data APIs, agentic payments, and up to ~30% cheaper
  LLM inference on select models.
---
...
| **Claude Sonnet 4.6** | $3.00 / $15.00 | $3.00 / $15.00   | At provider rate    |
