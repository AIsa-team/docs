...
description: "Track competitors, influencers, trends, mentions, and conversations on X/Twitter with automation-ready workflows."
---

[View on GitHub ->](https://github.com/AIsa-team/agent-skills/tree/main/x-intelligence-automation)

**Production skill details from the AIsa agent-skills registry.** Search X/Twitter profiles, tweets, trends, and approved engagement actions through the AIsa relay.
