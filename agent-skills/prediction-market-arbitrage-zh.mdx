...
description: "Find cross-platform prediction market price differences and potential arbitrage opportunities in Chinese-language workflows."
---

[View on GitHub ->](https://github.com/AIsa-team/agent-skills/tree/main/prediction-market-arbitrage-zh)

**Production skill details from the AIsa agent-skills registry.** 通过 [AIsa API](https://aisa.one) 发现 [Polymarket](https://polymarket.com) 和 [Kalshi](https://kalshi.com) 之间的套利机会。
