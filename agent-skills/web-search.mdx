...
**Production skill details from the AIsa agent-skills registry.** Search the web using the AIsa Scholar Web Search endpoint. Returns structured results with titles, URLs, and content snippets.
