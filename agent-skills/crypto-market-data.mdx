...
| `/coingecko/coins/{id}/contract/{contract_address}/market_chart/range` | GET    | [Historical chart range by contract](/api-reference/coingecko/coin-market-chart-range-by-contract)       |
