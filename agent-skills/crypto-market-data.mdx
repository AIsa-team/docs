...
| `/coingecko/coins/{id}/contract/{address}`                    | GET    | [Coin data by token address](/api-reference/coingecko/coin-data-by-token-address)                        |
| `/coingecko/coins/{id}/contract/{address}/market_chart`       | GET    | [Historical chart by contract](/api-reference/coingecko/coin-historical-chart-by-contract)               |
