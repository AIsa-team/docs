...
description: "Search and publish on X/Twitter through one command center workflow for profiles, tweets, trends, communities, DMs, follows, likes, and posting."
---

[View on GitHub ->](https://github.com/AIsa-team/agent-skills/tree/main/aisa-twitter-command-center)

**Production skill details from the AIsa agent-skills registry.** Search X/Twitter profiles, tweets, trends, lists, communities, and Spaces through the AIsa relay, then support approved posting workflows with OAuth.
