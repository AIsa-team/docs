...
**Production skill details from the AIsa agent-skills registry.** Analyze one or more stock or crypto tickers using the AIsa API with live Yahoo Finance data.
