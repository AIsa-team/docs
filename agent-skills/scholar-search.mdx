...
description: "Find academic papers, citations, and scholarly sources."
---
...
<CardGroup cols={3}>
  <Card title="Scholar API reference" icon="graduation-cap" href="/api-reference/scholar/post_scholar-search-scholar">
