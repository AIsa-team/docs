...
description: "Search X/Twitter users, tweets, trends, lists, communities, DMs, and publish or engage through a linked account."
---

[View on GitHub ->](https://github.com/AIsa-team/agent-skills/tree/main/twitter-command-center-search-post)

**Production skill details from the AIsa agent-skills registry.** **Twitter/X data access and automation for autonomous agents. Powered by AIsa.**
