...
description: "Query Polymarket and Kalshi prices, order books, positions, trades, and wallet metrics for Chinese-language workflows."
---

[View on GitHub ->](https://github.com/AIsa-team/agent-skills/tree/main/prediction-market-data-zh)

**Production skill details from the AIsa agent-skills registry.** 通过 [AIsa API](https://aisa.one) 查询 [Polymarket](https://polymarket.com) 和 [Kalshi](https://kalshi.com) 预测市场。
