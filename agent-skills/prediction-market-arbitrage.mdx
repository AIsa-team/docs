...
description: "Cross-platform arbitrage detection across prediction markets. Match equivalent events on Polymarket and Kalshi, compare implied probabilities, and verify orderbook depth before executing."
---
...
<Steps>
  ...
  <Step title="Compare prices">
    ...
    _Example:_ buying complementary outcomes at `0.40` and `0.55` totals `0.95` — a `0.05` edge before fees.
  </Step>
