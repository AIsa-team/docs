...
<IMPORTANT id="paid-api-approval-first">
  <before-paid-data-call>
    ...
    State the exact endpoint and scope, formula or rate, and documented maximum
    USD exposure; then obtain explicit approval for that scope and cap.
  ...
  <prohibited>
    Do not use a paid call to discover price, probe, test, or "just check";
    do not invent or call a quote API.
  </prohibited>
  <after-approval>
