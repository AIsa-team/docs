...
//   https://aisa.one/docs/api-reference/financial/get_prices-snapshot.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/financial/get_prices-snapshot)
