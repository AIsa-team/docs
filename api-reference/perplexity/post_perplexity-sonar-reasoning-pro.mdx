...
//   https://aisa.one/docs/api-reference/perplexity/post_perplexity-sonar-reasoning-pro.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/perplexity/post_perplexity-sonar-reasoning-pro)
