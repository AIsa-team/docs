...
description: "Retrieves a queued Seznam organic result by id as raw HTML."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-seznam-organic-task-get-html-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-seznam-organic-task-get-html-id)
