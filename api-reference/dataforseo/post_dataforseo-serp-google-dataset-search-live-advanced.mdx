...
description: "Returns datasets matching a query in Google Dataset Search on Google, synchronously."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-google-dataset-search-live-advanced.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-google-dataset-search-live-advanced)
