...
description: "Returns the ads running against a keyword on Google."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-google-ads-search-locations.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-google-ads-search-locations)
