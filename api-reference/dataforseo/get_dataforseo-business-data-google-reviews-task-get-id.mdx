---
title: "Get Business Data Google Reviews Results by id"
description: "Retrieves queued Google Business Profile reviews by id."
openapi: "openapi/dataforseo.json GET /dataforseo/business_data/google/reviews/task_get/{id}"
---
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-business-data-google-reviews-task-get-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-business-data-google-reviews-task-get-id)
