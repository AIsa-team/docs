...
description: "The locations the YouTube SERP endpoints accept, as location_code, location_name, location_code_parent, country_iso_code and location_type."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-youtube-locations.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-youtube-locations)
