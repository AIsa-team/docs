...
description: "Retrieves queued Trustpilot businesses matching a query - how to find the id the reviews endpoint needs by id."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-business-data-trustpilot-search-task-get-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-business-data-trustpilot-search-task-get-id)
