...
description: "Queues the job listings Google surfaces for a query on Google, returning a task id in tasks[0]."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-google-jobs-task-post.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-google-jobs-task-post)
