...
description: "The raw HTML of one Google Play listing."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-app-data-google-app-info-task-get-html-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-app-data-google-app-info-task-get-html-id)
