...
description: "Returns the instruments Google Finance groups under a theme on Google, synchronously."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-google-finance-explore-live-advanced.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-google-finance-explore-live-advanced)
