...
description: "Amazon products competing with a given product on shared search terms."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-dataforseo-labs-amazon-product-competitors-live.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-dataforseo-labs-amazon-product-competitors-live)
