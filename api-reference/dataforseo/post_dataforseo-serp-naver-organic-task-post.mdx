...
description: "Queues the ranked results for a keyword on Naver, returning a task id in tasks[0]."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-naver-organic-task-post.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-naver-organic-task-post)
