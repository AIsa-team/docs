...
description: "Ratings, reviews and install estimates for many App Store apps in one call."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-bulk-app-metrics-live.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-bulk-app-metrics-live)
