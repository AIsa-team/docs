...
description: "Returns the comments on one YouTube video on YouTube, synchronously."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-youtube-video-comments-live-advanced.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-youtube-video-comments-live-advanced)
