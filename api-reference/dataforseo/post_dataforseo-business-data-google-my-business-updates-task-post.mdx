...
description: "Queues the posts a business has published to its Google Business Profile, returning a task id."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-business-data-google-my-business-updates-task-post.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-business-data-google-my-business-updates-task-post)
