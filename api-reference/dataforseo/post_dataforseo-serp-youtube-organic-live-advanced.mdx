...
description: "Returns the ranked results for a keyword on YouTube, synchronously."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-youtube-organic-live-advanced.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-youtube-organic-live-advanced)
