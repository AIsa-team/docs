...
description: "The languages the Baidu SERP endpoints accept, as language_name and language_code."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-baidu-languages.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-baidu-languages)
