...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-ai-optimization-llm-mentions-available-filters.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-ai-optimization-llm-mentions-available-filters)
