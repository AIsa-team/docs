...
description: "Queues the list of sellers offering one Amazon product, returning a task id."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-merchant-amazon-sellers-task-post.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-merchant-amazon-sellers-task-post)
