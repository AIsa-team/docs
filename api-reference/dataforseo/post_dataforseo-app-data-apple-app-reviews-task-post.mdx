...
description: "Queues the reviews of one App Store app by app_id, returning a task id."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-app-data-apple-app-reviews-task-post.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-app-data-apple-app-reviews-task-post)
