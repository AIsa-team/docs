---
title: "Get Google Finance Explore HTML Results by id"
description: "Retrieves a queued Google finance explore result by id as raw HTML."
openapi: "openapi/dataforseo.json GET /dataforseo/serp/google/finance_explore/task_get/html/{id}"
---
