...
description: "Retrieves a queued Google search by image result by id."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-google-search-by-image-task-get-advanced-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-google-search-by-image-task-get-advanced-id)
