...
description: "Sends a user_prompt to a Claude model and returns its reply, synchronously."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-ai-optimization-claude-llm-responses-live.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-ai-optimization-claude-llm-responses-live)
