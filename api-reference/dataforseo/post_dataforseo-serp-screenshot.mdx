...
description: "Returns a rendered screenshot of a search result page on Google."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-serp-screenshot.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-serp-screenshot)
