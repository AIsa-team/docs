...
description: "Retrieves a queued Google jobs result by id."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-advanced-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-advanced-id)
