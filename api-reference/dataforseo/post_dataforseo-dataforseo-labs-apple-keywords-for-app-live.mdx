...
description: "The keywords an App Store app ranks for."
...
//   https://aisa.one/docs/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-keywords-for-app-live.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/post_dataforseo-dataforseo-labs-apple-keywords-for-app-live)
