...
description: "Returns the events Google surfaces for a query on Google."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-google-events-locations.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-google-events-locations)
