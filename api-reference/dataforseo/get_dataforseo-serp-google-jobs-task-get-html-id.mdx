...
description: "Retrieves a queued Google jobs result by id as raw HTML."
...
//   https://aisa.one/docs/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-html-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/dataforseo/get_dataforseo-serp-google-jobs-task-get-html-id)
