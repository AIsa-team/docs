---
title: "Error Codes"
description: "HTTP status codes, error payload shape, and recommended retry strategies for the AIsa API."
---
...
**Action:** Double-check the model name against the [model catalog](/guides/models) and the endpoint path against the [API reference](/api-reference/chat/post_chat-completions).
</Accordion>
