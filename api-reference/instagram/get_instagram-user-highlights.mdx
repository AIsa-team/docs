...
//   https://aisa.one/docs/api-reference/instagram/get_instagram-user-highlights.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/instagram/get_instagram-user-highlights)
