---
title: Polymarket Orderbook History
description: "Get Polymarket Orderbook History"
excerpt: >-
  Fetches historical orderbook snapshots for a specific asset (token ID) over a
  specified time range.
openapi: "openapi/polymarket-openapi.json GET /polymarket/orderbooks"
---
