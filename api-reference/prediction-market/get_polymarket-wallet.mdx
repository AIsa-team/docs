...
description: "Get Polymarket Wallet"
excerpt: >-
  Fetches wallet information by EOA address, proxy address, or user handle, with
  optional trading metrics.
openapi: "openapi/polymarket-openapi.json GET /polymarket/wallet"
---
