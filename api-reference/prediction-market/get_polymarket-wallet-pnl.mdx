...
excerpt: >-
  Fetches realized profit and loss (PnL) for a wallet address over a specified
  time range and granularity.
openapi: "openapi/polymarket-openapi.json GET /polymarket/wallet/pnl/{wallet_address}"
---
