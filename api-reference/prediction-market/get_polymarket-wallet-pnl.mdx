...
description: "Realized profit and loss for a Polymarket wallet address over a specified time range and granularity."
openapi: "openapi/polymarket-openapi.json GET /polymarket/wallet/pnl"
---
