---
title: Polymarket Trade History
description: "Get Polymarket Trade History"
excerpt: >-
  Fetches historical trade data with optional filtering by market, condition,
  token, time range, and user wallet address.
openapi: "openapi/polymarket-openapi.json GET /polymarket/orders"
---
