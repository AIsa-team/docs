...
excerpt: >-
  Fetches historical candlestick data for a market identified by condition ID
  over a specified interval.
openapi: "openapi/polymarket-openapi.json GET /polymarket/candlesticks/{condition_id}"
---
...
```curl
curl -X GET "https://api.aisa.one/apis/v1/polymarket/candlesticks/0x1234abcd5678ef90?start_time=1640995200&end_time=1672531200&interval=1440" \
