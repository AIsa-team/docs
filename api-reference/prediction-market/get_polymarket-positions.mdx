...
excerpt: >-
  Fetches all Polymarket positions for a proxy wallet address with market info
  and redemption status.
openapi: "openapi/polymarket-openapi.json GET /polymarket/positions/wallet/{wallet_address}"
---
