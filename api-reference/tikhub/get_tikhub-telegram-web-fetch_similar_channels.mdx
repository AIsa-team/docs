...
openapi: "openapi/tikhub-en.json GET /tikhub/telegram/web/fetch_similar_channels"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/telegram/web/fetch_similar_channels?channel=durov" \
