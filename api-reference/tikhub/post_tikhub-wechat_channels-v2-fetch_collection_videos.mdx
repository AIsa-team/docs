---
title: "Get WeChat Channels Collection Videos"
description: "Get WeChat Channels Collection Videos"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_channels/v2/fetch_collection_videos"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_channels/v2/fetch_collection_videos" \
