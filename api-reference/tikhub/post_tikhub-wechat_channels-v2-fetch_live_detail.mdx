---
title: "Get WeChat Channels Live Detail"
description: "Get WeChat Channels Live Detail"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_channels/v2/fetch_live_detail"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_channels/v2/fetch_live_detail" \
