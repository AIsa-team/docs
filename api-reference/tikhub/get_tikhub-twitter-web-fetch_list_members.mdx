...
openapi: "openapi/tikhub-en.json GET /tikhub/twitter/web/fetch_list_members"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/twitter/web/fetch_list_members?list_id=84839422" \
