---
title: "Get user reposts list"
description: "Get user reposts list"
openapi: "openapi/tikhub-en.json GET /tikhub/instagram/v1/fetch_user_reposts"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/instagram/v1/fetch_user_reposts?user_id=25025320" \
