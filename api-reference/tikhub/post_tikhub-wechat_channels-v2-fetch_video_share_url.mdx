---
title: "Generate WeChat Channels Video Share URL"
description: "Generate WeChat Channels Video Share URL"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_channels/v2/fetch_video_share_url"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_channels/v2/fetch_video_share_url" \
