---
title: "Get community timeline"
description: "Get community timeline"
openapi: "openapi/tikhub-en.json GET /tikhub/twitter/web/fetch_community_timeline"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/twitter/web/fetch_community_timeline?community_id=1493290339532222469" \
