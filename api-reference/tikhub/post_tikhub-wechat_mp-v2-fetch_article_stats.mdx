---
title: "Get WeChat MP Article Stats"
description: "Get WeChat MP Article Stats"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_mp/v2/fetch_article_stats"
---

Get WeChat MP Article Stats
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_mp/v2/fetch_article_stats" \
