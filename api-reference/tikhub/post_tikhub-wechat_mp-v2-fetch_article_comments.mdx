---
title: "Get WeChat MP Article Comments"
description: "Get WeChat MP Article Comments"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_mp/v2/fetch_article_comments"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_mp/v2/fetch_article_comments" \
