...
openapi: "openapi/tikhub-en.json GET /tikhub/weibo/web_v2/fetch_ai_search"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/weibo/web_v2/fetch_ai_search?query=#France#" \
