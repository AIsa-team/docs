---
title: "Get post comment replies"
description: "Get post comment replies"
openapi: "openapi/tikhub-en.json GET /tikhub/youtube/web_v2/get_post_comment_replies"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/youtube/web_v2/get_post_comment_replies?continuation_token=VALUE" \
