---
title: "Get WeChat MP Account Services & Custom Menu"
description: "Get WeChat MP Account Services & Custom Menu"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_mp/v2/fetch_account_services"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_mp/v2/fetch_account_services" \
