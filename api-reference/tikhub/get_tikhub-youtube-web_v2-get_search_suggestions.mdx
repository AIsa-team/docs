...
openapi: "openapi/tikhub-en.json GET /tikhub/youtube/web_v2/get_search_suggestions"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/youtube/web_v2/get_search_suggestions?keyword=Rick Astley" \
