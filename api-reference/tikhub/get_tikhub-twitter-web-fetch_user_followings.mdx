...
openapi: "openapi/tikhub-en.json GET /tikhub/twitter/web/fetch_user_followings"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/twitter/web/fetch_user_followings?screen_name=elonmusk" \
