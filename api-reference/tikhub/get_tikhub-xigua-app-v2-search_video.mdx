...
openapi: "openapi/tikhub-en.json GET /tikhub/xigua/app/v2/search_video"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/xigua/app/v2/search_video?keyword=See API documentation" \
