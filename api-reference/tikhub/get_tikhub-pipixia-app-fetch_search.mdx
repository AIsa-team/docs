...
openapi: "openapi/tikhub-en.json GET /tikhub/pipixia/app/fetch_search"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/pipixia/app/fetch_search?keyword=See API documentation" \
