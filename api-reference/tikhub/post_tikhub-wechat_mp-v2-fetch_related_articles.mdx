---
title: "Get WeChat MP Related Articles"
description: "Get WeChat MP Related Articles"
openapi: "openapi/tikhub-en.json POST /tikhub/wechat_mp/v2/fetch_related_articles"
---
...
```bash
curl -X POST "https://api.aisa.one/apis/v1/tikhub/wechat_mp/v2/fetch_related_articles" \
