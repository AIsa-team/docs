...
openapi: "openapi/tikhub-en.json GET /tikhub/douyin/xingtu_v2/search_anchor"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/douyin/xingtu_v2/search_anchor?keyword=games" \
