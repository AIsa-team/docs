...
openapi: "openapi/tikhub-en.json GET /tikhub/kuaishou/app/search_live"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/kuaishou/app/search_live?keyword=live commerce" \
