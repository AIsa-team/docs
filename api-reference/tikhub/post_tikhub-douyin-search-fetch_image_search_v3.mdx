---
title: "Fetch image-text search V3"
description: "获取图文搜索 V3/Fetch image-text search V3"
openapi: "openapi/tikhub.json POST /tikhub/douyin/search/fetch_image_search_v3"
---
