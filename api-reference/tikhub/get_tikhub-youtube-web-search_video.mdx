...
openapi: "openapi/tikhub-en.json GET /tikhub/youtube/web/search_video"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/youtube/web/search_video?search_query=Minecraft" \
