---
title: "Get channel description"
description: "Get channel description"
openapi: "openapi/tikhub-en.json GET /tikhub/youtube/web_v2/get_channel_description"
---
...
```bash
curl "https://api.aisa.one/apis/v1/tikhub/youtube/web_v2/get_channel_description" \
