...
//   https://aisa.one/docs/api-reference/agentmail/get_agentmail-inboxes-inbox-id-lists-direction-type-entry.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/get_agentmail-inboxes-inbox-id-lists-direction-type-entry)
