...
//   https://aisa.one/docs/api-reference/agentmail/get_agentmail-inboxes-inbox-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/get_agentmail-inboxes-inbox-id)
