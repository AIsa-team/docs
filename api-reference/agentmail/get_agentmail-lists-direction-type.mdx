...
//   https://aisa.one/docs/api-reference/agentmail/get_agentmail-lists-direction-type.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/get_agentmail-lists-direction-type)
