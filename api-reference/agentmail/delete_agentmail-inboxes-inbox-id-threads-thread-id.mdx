...
//   https://aisa.one/docs/api-reference/agentmail/delete_agentmail-inboxes-inbox-id-threads-thread-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/delete_agentmail-inboxes-inbox-id-threads-thread-id)
