...
//   https://aisa.one/docs/api-reference/agentmail/patch_agentmail-inboxes-inbox-id-drafts-draft-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/patch_agentmail-inboxes-inbox-id-drafts-draft-id)
