...
//   https://aisa.one/docs/api-reference/agentmail/post_agentmail-inboxes-inbox-id-messages-send.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/post_agentmail-inboxes-inbox-id-messages-send)
