...
//   https://aisa.one/docs/api-reference/agentmail/get_agentmail-inboxes-inbox-id-threads-thread-id-attachments-attachment-id.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/get_agentmail-inboxes-inbox-id-threads-thread-id-attachments-attachment-id)
