...
//   https://aisa.one/docs/api-reference/agentmail/delete_agentmail-lists-direction-type-entry.md
...
[Set this endpoint up in your agent →](https://aisa.one/mcp?from=/api-reference/agentmail/delete_agentmail-lists-direction-type-entry)
